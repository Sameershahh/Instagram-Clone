  ...
  router.post('/register',function(req,res,next){ //to create new user 
    const userData = new userModel({
    username:req.body.username,
    name:req.body.name,
    email:req.body.email,
    });
    userModel.register(userData, req.body.password)  //to create password stuff in registering new user
    .then(function(){
  ...
  const user =  await userModel.findOneAndUpdate(
    ...
    {fullname: req.body.fullname, username: req.body.username, bio: req.body.bio}, 
    {new: true});
